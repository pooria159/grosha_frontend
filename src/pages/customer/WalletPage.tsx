        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen p-4 md:p-8" style={{ direction: 'rtl' }}>
            <div className="max-w-6xl mx-auto">
                <div className="mb-6 md:mb-8 text-center">
                    <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#1e3a8a] flex items-center justify-center">
                        <FiCreditCard className="ml-2 text-[#3b82f6]" size={24} />
                ...
                <div className="space-y-4 md:space-y-6">
                    <div className="bg-gradient-to-r from-[#1e3a8a] to-[#3b82f6] rounded-xl md:rounded-2xl p-4 md:p-6 text-white shadow-lg relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-full h-full opacity-10 bg-white"></div>
                        <div className="relative z-10">
                            <div className="flex justify-between items-start">
                                <div>
                                    <h2 className="text-lg md:text-xl font-semibold mb-1 md:mb-2">موجودی کیف پول</h2>
                                    <p className="text-2xl md:text-3xl font-bold mb-4 md:mb-6">{formatCurrency(walletBalance)}</p>
                                </div>
                                <button 
                                    onClick={handleRefresh}
                                    className={`p-1 md:p-2 rounded-full ${isRefreshing ? 'animate-spin' : 'hover:bg-white/10'}`}
                            ...
                            <div className="flex flex-col md:flex-row gap-2 md:gap-4">
                                <button
                                    ...
                                    className="flex-1 bg-white/10 hover:bg-white/20 border border-white/30 px-4 py-2 md:px-6 md:py-3 rounded-lg font-semibold transition-all duration-300 hover:shadow-md flex items-center justify-center gap-2 text-sm md:text-base"
                                >
                    ...
                    {error && (
                        <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-3 md:p-4 rounded-lg">
                    ...
                    <div className="bg-white rounded-xl md:rounded-2xl shadow-md overflow-hidden">
                        <div className="p-4 md:p-6 border-b border-gray-200">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-4">
                                <h2 className="text-lg md:text-xl font-bold text-gray-800 flex items-center">
                                    <FaRegCreditCard className="ml-2 text-[#3b82f6]" size={18} />
                                    کارت‌های بانکی من
                                </h2>
                                <div className="flex items-center gap-2 md:gap-3">
                                    ...
                                    <button
                                        onClick={() => setIsAdding(true)}
                                        className="flex items-center gap-1 md:gap-2 bg-[#3b82f6] hover:bg-[#2563eb] text-white px-3 py-1.5 md:px-4 md:py-2 rounded-lg text-xs md:text-sm font-medium transition-all duration-300 hover:shadow-md"
                                    >
                                        <FiPlus size={14} />
                                        افزودن کارت
                                    </button>
                        ...
                        {isLoading ? (
                            ...
                            <div className="p-6 md:p-8 text-center bg-gray-50">
                                <div className="mx-auto w-12 h-12 md:w-16 md:h-16 bg-gray-200 rounded-full flex items-center justify-center mb-3 md:mb-4">
                                    <FaRegCreditCard size={20} className="text-gray-400" />
                                </div>
                                <p className="text-gray-500 text-sm md:text-base">هیچ کارتی ثبت نشده است</p>
                                <button
                                    onClick={() => setIsAdding(true)}
                            ...
                            <div className="divide-y divide-gray-200">
                                {bankCards.map((card) => (
                                    <div key={card.id} className="p-4 md:p-6 hover:bg-gray-50 transition-colors duration-200 group">
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
                                            <div className="flex items-center gap-3 md:gap-4">
                                                <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-blue-100 flex items-center justify-center">
                                                    <FaRegCreditCard size={18} className="text-blue-600" />
                                                </div>
                                                <div className="min-w-0">
                                                    <h3 className="font-medium text-gray-800 text-sm md:text-base truncate">{card.card_name}</h3>
                                                    <div className="flex items-center mt-1">
                                                        <p className="font-mono tracking-wider text-gray-600 text-xs md:text-sm" style={{direction: 'ltr'}}>
                                            ...
                                            <div className="flex items-center gap-2 md:gap-3 mt-2 md:mt-0">
                                                ...
                                                <div className="flex gap-1 md:gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                                    <button
                                                        ...
                                                        className="p-1.5 md:p-2 bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full transition-colors duration-200"
                                                        title="ویرایش"
                                                    >
                                                        <FiEdit2 size={14} />
                                                    </button>
                                                    <button
                                                        ...
                                                        className="p-1.5 md:p-2 bg-red-100 hover:bg-red-200 text-red-600 rounded-full transition-colors duration-200"
                                                        title="حذف"
                                                    >
                                                        <FiTrash2 size={14} />
                                                    </button>
                        ...
                        <div className="bg-white rounded-xl md:rounded-2xl shadow-md overflow-hidden">
                            <div className="p-4 md:p-6 border-b border-gray-200 bg-gray-50">
                                <div className="flex justify-between items-center">
                                    <h2 className="text-lg md:text-xl font-bold text-gray-800 flex items-center">
                                        <FiPlus className="ml-2 text-blue-600" size={18} />
                                        افزودن کارت جدید
                                    </h2>
                                    <button
                                        onClick={() => {
                            ...
                            <div className="p-4 md:p-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-6">
                                    <div>
                                        <label className="block text-gray-700 mb-1 md:mb-2 font-medium text-sm md:text-base">نام دارنده کارت</label>
                                        <input
                                            type="text"
                                            className="w-full p-2 md:p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm md:text-base"
                                    ...
                                    <div>
                                        <label className="block text-gray-700 mb-1 md:mb-2 font-medium text-sm md:text-base">شماره کارت</label>
                                        <input
                                            type="text"
                                            className={`w-full p-2 md:p-3 border ${cardNumberError ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm md:text-base`}
                                        ...
                                        />
                                        {cardNumberError && (
                                            <p className="text-red-500 text-xs md:text-sm mt-1 md:mt-2">{cardNumberError}</p>
                                        )}
                                    </div>
                                </div>
                                <div className="flex flex-col md:flex-row items-stretch md:items-center gap-2 md:gap-3">
                                    <button
                                        ...
                                        className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 md:px-6 md:py-3 rounded-lg font-medium transition-all duration-300 hover:shadow-md flex items-center justify-center gap-2 text-sm md:text-base"
                                    >
                                        <FiCheck size={16} />
                                        ذخیره کارت
                                    </button>
                                    <button
                                        ...
                                        className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 md:px-6 md:py-3 rounded-lg font-medium transition-all duration-300 hover:shadow-md flex items-center justify-center gap-2 text-sm md:text-base"
                                    >
                                        <FiX size={16} />
                                        انصراف
                                    </button>
                    ...
                    {editingCard && (
                        <div className="bg-white rounded-xl md:rounded-2xl shadow-md overflow-hidden">
                            <div className="p-4 md:p-6 border-b border-gray-200 bg-gray-50">
                                <div className="flex justify-between items-center">
                                    <h2 className="text-lg md:text-xl font-bold text-gray-800 flex items-center">
                                        <FiEdit2 className="ml-2 text-blue-600" size={18} />
                                        ویرایش کارت بانکی
                                    </h2>
                                    <button
                                        onClick={() => {
